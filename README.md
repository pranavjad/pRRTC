...
single_mbm.cpp let users to benchmark the performance of Panda, Fetch, or Baxter on [MotionBenchMaker](https://github.com/KavrakiLab/motion_bench_maker), and the script enables users to select only one problem for benchmarking. To run single_mbm.cpp:
```
